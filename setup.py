...
description = "Work with chemical signatures"

setuptools.setup(
    name=name,
    version=version,
    author=["jfaulon", "tduigou", "guillaume-gricourt"],
    description=description,
    long_description_content_type="text/markdown",
    url="https://github.com/brsynth/retrosig",
    package_dir={"": "src"},
    ...
    entry_points={"console_scripts": ["retrosig=retrosig.__main__:main"]},
)
